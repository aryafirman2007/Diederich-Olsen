...
╰──── •`, mentions: [num] })
              ...
              oka.sendMessage(anu.id, { mentions: [num], text: `@${num.split("@")[0]} Selamat, kamu jadi admin GC ini` })
            } else if ( anu.action === 'demote' ) {
              oka.sendMessage(anu.id, { mentions: [num], text: `@${num.split("@")[0]} WKWKWKWK BUKAN ADMIN LAGI` })
            }
          }
      } catch (err) {
      console.log(`ERROR DIBAGIAN ` + err)
