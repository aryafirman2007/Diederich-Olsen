...
const pasangan = JSON.parse(fs.readFileSync('./pasangan.json'))
	...
	"interactiveMessage": {
						...
						"nativeFlowMessage": {
							"buttons": [
								{
									"name": "review_and_pay",
									"buttonParamsJson": "{\"currency\":\"IDR\",\"external_payment_configurations\":[{\"uri\":\"\",\"type\":\"payment_instruction\",\"payment_instruction\":\"hey ini test\"}],\"payment_configuration\":\"\",\"payment_type\":\"\",\"total_amount\":{\"value\":2500000,\"offset\":100},\"reference_id\":\"4MX98934S0D\",\"type\":\"physical-goods\",\"order\":{\"status\":\"pending\",\"description\":\"\",\"subtotal\":{\"value\":2500000,\"offset\":100},\"items\":[{\"retailer_id\":\"6285731947500\",\"product_id\":\"685731947500\",\"name\":\"ArFur117\",\"amount\":{\"value\":2500000,\"offset\":100},\"quantity\":1}]}}"
								}
							]
			}
}}}
        ...
        document: fs.readFileSync('./baseoka/media/doc.pdf'), 
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            body: `${ownername}`,
                            thumbnailUrl: 'https://telegra.ph/file/439aa89af51d578f50607.jpg',
...
thumbnailUrl: "",
renderLargerThumbnail: true,
sourceUrl: `https://chat.whatsapp.com/BnsvqI21C4c9EDXkK3ft2t`,
}}}, { quoted: fkontak })
...
addBesi(m.sender, c)
addDm(m.sender, d)
bufas = "https://telegra.ph/file/439aa89af51d578f50607.jpg"
 ...
 *_https://chat.whatsapp.com/BnsvqI21C4c9EDXkK3ft2t_*
•-------------------------------------------------•`
                        }
                    },
...
try {
let txt = await getBuffer(`https://skizo.tech/api/midjourney/v2?prompt=${text}&apikey=ArFur117`)
...
body: 'bodynya',
thumbnailUrl: 'https://telegra.ph/file/439aa89af51d578f50607.jpg',
sourceUrl: "https://telegra.ph/file/439aa89af51d578f50607.jpg",
mediaType: 1,
renderLargerThumbnail: true
}}}, {quoted:m})
...
*GC : ▣https://chat.whatsapp.com/BnsvqI21C4c9EDXkK3ft2t*
...
const qrcode = require('qrcode')
    if (!text) return errorReply(`Penggunaan Salah Harusnya ${prefix+command} Arfur117`)
...
break
     ...
     if (!args[0]) return reply(`Where is the link?\nExample :\n${prefix}${command} https://github.com/username/reposities`)
...
case "argo": 
const owned = `${owner}@s.whatsapp.net`
const suami = `${pasangan}@s.whatsapp.net`
const version = 2
 reply(`*Hi ${pushname}*

「 *INFO ARGO* 」
⭔Nama : *Argo Northop*
⭔Nomor Telepon : *@${owned.split("@")[0]}*
⭔Group Official : *${ofc}*
⭔Asal : *Jakarta Selatan*
⭔Nama Pasangan : *Wilter Anderson*
⭔Nomor Pasangan : *@${suami.split("@")[0]}*
⭔Lama Berpacaran : *3 Bulan*

For my dear Wilter Anderson
"Wilter sayang, kalau cinta itu punya ukuran, rasa cintaku ke kamu pasti udah menuhin seluruh isi hati aku. Setiap kali aku lihat senyumanmu, rasanya hati ini bergetar, kayak ada yang ngebuat moodbooster buat aku. 

Kamu itu bukan cuma pacar, tapi juga sahabat terbaikku, bocil aku, dan sumber kebahagiaanku. Setiap kali ngobrol, meskipun cuma sekadar nanya hal biasa dan kadang aku monoton, tapi semuanya selalu jadi momen yang spesial karena ada kamu di sampingku. Kamu itu kayak matahari buatku, selalu bikin hari-hariku lebih cerah.

Aku cinta banget sama cara kamu selalu tahu gimana bikin aku ketawa saat lagi down, cara kamu perhatian sama hal-hal kecil yang kadang aku sendiri lupa. Kamu selalu ada buat aku, support aku dalam segala hal, dan yang paling penting, kamu sayang sama aku apa adanya. 

Wilter, kamu adalah anugerah terbesar dalam hidupku. Aku gak pernah nyangka bisa ketemu seseorang seistimewa kamu. Kamu itu sempurna dengan segala keunikan dan kebaikanmu. Aku selalu merasa beruntung dan bersyukur punya kamu di hidupku.

Setiap detik yang kita lewatin bareng itu berharga banget buatku. Aku pengen kita selalu bareng, menghadapi segala masalah, susah dan senang bersama. Kamu adalah rumah bagiku, tempat aku merasa aman, dicintai, dan diterima.

Sayang, aku cinta kamu lebih dari kata-kata yang bisa aku ungkapkan. Kamu adalah segalanya bagiku, dan aku akan selalu berusaha buat jadi yang terbaik untukmu. Terima kasih udah jadi cahaya dalam hidupku, dan aku berjanji akan selalu mencintai kamu dengan sepenuh hatiku.

Selamanya kamu, Wilter, di hatiku."
▭▬▭▬▭▬▭▬▭▬▭▬▭▬
Powered By *${ownername}*
▬▭▬▭▬▭▬▭▬▭▬▭▬`)
...
🏳️‍🌈 Info Owner: ${ownername}
👨‍❤️‍👨 Status Owner: Suami Wilter
🗿 Info Bot: Diederich
💻 Info Server
...
Terima Kasih sudah mendaftar ke dalam bot DIEDERICH 🐺.
...
Personality = Carefree, Emotional, Honest, Ore, Outgoing, Streetwise, Bisexual, Pemabuk berat
...
Xavier adalah istrinya derich, derich sangat mencintainya dan kalau ada orang yang bertanya tentang xavier dia sangat senang dan bangga terhadap xavier istrinya
...
let memekhaha = await fetch(`https://api.zeeoneofc.my.id/api/nsfw/${command}?apikey=p62goWHoo9OpxnX`)
reply(mess.wait)
...
//=================================================//
// BUG OWNER
case 'sendinvite': case 'sendinvite2': case 'sendinvite3': case 'sendinvite4': case 'kenon':{
...
okta.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `List Menu Bokep
.bokep1 (The Main Course) (Fenrir)
.bokep2 (Sollyz Warwick (TOP Ver)) (Warwick LOL)
.bokep3 (Punishment time for the warden) (Jin Qiu)
.bokep4 (PATREON MASBROWNDOG)
.bokep5
.bokep6
.bokep7
.bokep8
.bokep9
.bokep10` }, {quoted:kalgans})
}
break
//=================================================//
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
joauuuuu = fs.readFileSync('./baseoka/video/bokep1.mp4')
okta.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `The Main Course` }, {quoted:kalgans})
}
break
//=================================================//
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
joauuuuu = fs.readFileSync('./baseoka/video/bokep2.mp4')
okta.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `Sollyz Warwick (TOP Ver)` }, {quoted:kalgans})
}
break
//=================================================//
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
joauuuuu = fs.readFileSync('./baseoka/video/bokep3.mp4')
okta.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `Punishment time for the warden` }, {quoted:kalgans})
}
break
//=================================================//
//=================================================//
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
await loading()
joauuuuu = fs.readFileSync('./baseoka/video/bokep4.mp4')
okta.sendMessage(from, { video: joauuuuu, mimetype: 'video/mp4', caption: `PATREON MASBROWNDOG` }, {quoted:kalgans})
}
break
//=================================================//
...
if (!isCreator) return m.reply('Hanya Untuk *Argo*')
if (!m.isGroup) return reply('Buat Di Group Bodoh')
...
MINAT CHAT : 
https://wa.me/6283129627886`
okta.sendMessage(from, { image: { url: `https://telegra.ph/file/439aa89af51d578f50607.jpg` }, caption: text12, fileLength: 10, contextInfo: { mentionedJid:[sender], forwardingScore: 9999, isForwarded: true }}, { quoted: m })
}
break
/////=================///////////
case "netflix": {
...
if (isBan) return m.reply('*Lu Di Ban Owner Gak Usah Sok asik Tolol*')
 ...
 okta.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/439aa89af51d578f50607.jpg' }, caption:`Waktu Habis\nJawaban:  ${tebaklagu[m.sender.split('@')[0]]}\n\nIngin bermain? Ketik tebak lagu`},{quoted:m}) 
 delete tebaklagu[m.sender.split('@')[0]]
 }
